...
var AuthController = /** @class */ (function () {
    ...
    AuthController.login = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, email, password, userRepository, user, isPasswordValid, token, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        isPasswordValid = encrypt_1.encrypt.comparepassword(user.password, password);
                        if (!isPasswordValid) {
                        ...
                        return [2 /*return*/, res.status(200).json({ message: "Login successful!.", data: user, token: token })];
                    case 2:
                        error_1 = _b.sent();
    ...
    AuthController.getProfile = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        user = _a.sent();
                        return [2 /*return*/, res.status(200).json({ message: "Get profile successfully!.", data: user, password: undefined })];
                }
            });
        });
    };
